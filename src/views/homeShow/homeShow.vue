<template>
  <div style="height:100vh;">
    <div class="home-box">
      <div class="main-left">
        <div class="h-m-l1" @click="dialogTableVisible = true">
          <div class="min-box">
      ...
      <div class="main-center">
        <div class="h-m-c1">
          <div class="min-box">
            ...
            <el-tabs
              ...
              class="attendance"
              type="card"
              @tab-click="attendanceClick"
            >
              <el-tab-pane label="班组" name="team">
                <div style="padding: 0 100px;">
                  <el-row :gutter="30">
                    <el-col :span="5">
                      <div class="grid-tabshow">
                        <p class="tab-title">班组1</p>
                        <p class="tab-con">51612</p>
                      </div>
                    </el-col>
                    <el-col :span="5">
                      <div class="grid-tabshow">
                        <p class="tab-title">班组2</p>
                        <p class="tab-con">3254</p>
                      </div>
                    </el-col>
                    <el-col :span="5">
                      <div class="grid-tabshow">
                        <p class="tab-title">班组3</p>
                        <p class="tab-con">4888</p>
                      </div>
                    </el-col>
                    <el-col :span="5">
                      <div class="grid-tabshow">
                        <p class="tab-title">班组4</p>
                        <p class="tab-con">57159</p>
                      </div>
                    </el-col>
                    <el-col :span="4">
                      <div class="grid-tabshow">
                        <p class="tab-title">班组5</p>
                        <p class="tab-con">249</p>
                      </div>
                    </el-col>
                  </el-row>
                </div>
        ...
        <div class="h-m-c3">
          <div class="min-box" style="display:flex;">
            <div
              style="position:absolute;top:10px;left: 20px;width:200px;height:20px;color:rgba(0,88,162,1);font-weight:bold;font-family:Microsoft YaHei;font-size:14px;"
            >
              <span>出勤率</span>
            </div>
            <div style="width:25%;">
                ...
                <div style="text-algin: center;">
                  <el-row>
                    <el-col :span="6" :push="4">
                      <div class="grid-tab-title">姓名</div>
                    </el-col>
                    <el-col :span="6" :push="2">
                      <div class="grid-tab-title">工号</div>
                    </el-col>
                    <el-col :span="6" :push="1">
                      <div class="grid-tab-title">班组</div>
                    </el-col>
                    <el-col :span="6">
                      <div class="grid-tab-title">时间</div>
                    </el-col>
                  </el-row>
                </div>
                <div class="con" style="padding-top: 20px">
                  <el-row class="dynamicRow">
                    <el-col :span="2">
                      <div class="grid-con">
                        <img
                          src="../../assets/images/home/home-logo1.png"
                          width="24px"
                          height="24px"
                        />
                      </div>
                    ...
                    <el-col :span="4" :push="1">
                      <div class="grid-con">紫通</div>
                    </el-col>
                    <el-col :span="5">
                      <div class="grid-con">3265421532</div>
                    </el-col>
                    <el-col :span="5" :push="1">
                      <div class="grid-con">昌平三班</div>
                    </el-col>
                    <el-col :span="8">
                      <div class="grid-con">2020-4-30 15:00</div>
                    </el-col>
                  </el-row>
                  <el-row class="dynamicRow">
                    <el-col :span="2">
    ...
    <div class="dialogTable">
      <el-dialog title="现场人员" :visible.sync="dialogTableVisible" width="90%">
        <el-table :data="tableData" border style="width: 100%" :header-cell-style="headClass">
          <el-table-column prop="date" label="钢筋工" width="150"></el-table-column>
          <el-table-column prop="name" label="电焊工" width="120"></el-table-column>
          <el-table-column prop="province" label="木工" width="120"></el-table-column>
          <el-table-column prop="city" label="瓦工" width="120"></el-table-column>
          <el-table-column prop="address" label="力工" width="300"></el-table-column>
          <el-table-column prop="zip" label="钢结构" width="120"></el-table-column>
          <el-table-column prop="zip" label="消防安装工" width="120"></el-table-column>
          <el-table-column prop="zip" label="土方" width="120"></el-table-column>
          <el-table-column prop="zip" label="保温" width="120"></el-table-column>
          <el-table-column prop="zip" label="降水" width="120"></el-table-column>
          <el-table-column prop="zip" label="人防" width="120"></el-table-column>
          <el-table-column prop="zip" label="电梯安装工" width="120"></el-table-column>
          <el-table-column prop="zip" label="二次结构" width="120"></el-table-column>
          <el-table-column prop="zip" label="调车司机" width="120"></el-table-column>
          <el-table-column prop="zip" label="挖机司机" width="120"></el-table-column>
          <el-table-column prop="zip" label="铲车司机" width="120"></el-table-column>
          <el-table-column prop="zip" label="放线工" width="120"></el-table-column>
          <el-table-column prop="zip" label="爆破工" width="120"></el-table-column>
          <el-table-column prop="zip" label="强电" width="120"></el-table-column>
          <el-table-column prop="zip" label="钢结构" width="120"></el-table-column>
          <el-table-column prop="zip" label="钢结构" width="120"></el-table-column>
          <el-table-column prop="zip" label="钢结构" width="120"></el-table-column>
          <el-table-column prop="zip" label="钢结构" width="120"></el-table-column>
            ...
            itemStyle: {
              ...
              color: {
                ...
                colorStops: [
                  ...
                  {
                    offset: 0.5,
                    color: "#36BC64" // 100% 处的颜色
                  },
                  {
                    offset: 1,
                    color: "#B2FFB7" // 100% 处的颜色
                  }
                ],
                global: false // 缺省为 false
              }
            }, //线条样式
            data: [170, 50, 99, 220, 86, 27, 71]
          },
          {
            name: "离职人员",
            type: "line",
