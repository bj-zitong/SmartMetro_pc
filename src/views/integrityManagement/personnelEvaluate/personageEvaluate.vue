      ...
      <el-main class="table-head">
        <div class="table-content">
          ...
          >
            ...
            <el-table-column prop="idNum" label="型号"></el-table-column>
            <el-table-column prop="phone" label="工号"></el-table-column>
            <el-table-column prop="company" label="承建单位"></el-table-column>
            <el-table-column prop="profession" label="所在班组"></el-table-column>
            <el-table-column prop="direction" label="工种"></el-table-column>
