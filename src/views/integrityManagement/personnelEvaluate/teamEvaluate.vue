      ...
      <el-main class="table-head">
        <div class="table-content">
          ...
          >
            ...
            <el-table-column prop="idNum" label="班组名称"></el-table-column>
            <el-table-column prop="phone" label="班组长"></el-table-column>
            <el-table-column prop="company" label="班组类型"></el-table-column>
            <el-table-column prop="profession" label="包含成员"></el-table-column>
            <el-table-column prop="direction" label="评价记录"></el-table-column>
          </el-table>
        </div>
